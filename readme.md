...
This branch `paper` of the repository contains the code for the
publication:

> Fischer, S. H. (2026). Empirical management strategies can simplify
> fisheries management in ICES. ICES Journal of Marine Science 83(7):
> 14pp. <https://doi.org/10.1093/icesjms/fsag129>
...
as part of the ICES WKBPLAICE 2024 benchmark. The code used during this
benchmark is in the branch
[`WKBPLAICE2024`](https://github.com/shfischer/WKBPLAICE2024_ple.27.7e_MSE/tree/WKBPLAICE2024).
...
- `OM_*`: Scripts for operating models (OMs, including alternative OMs)
  ...
  - [`OM_analysis.R`](https://github.com/shfischer/WKBPLAICE2024_ple.27.7e_MSE/blob/paper/OM_analysis.R):
    script for analysing and plotting OMs
...
- `MP_*`: Script for running and analysing the MSE
  ...
  - [`MP_run_local.R`](https://github.com/shfischer/WKBPLAICE2024_ple.27.7e_MSE/blob/paper/MP_run_local.R):
